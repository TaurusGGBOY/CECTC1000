...
public class AdminPeo extends JPanel {
    ...
    private String[] columnNames = {"����", "ID", "״̬", "ע��ʱ��", "����¼", "���ǳ�"};
    ...
    public AdminPeo() {
        ...
        dtm.setColumnIdentifiers(columnNames);// ������ͷ����ͷ�����Ϳ�����vector ����Object[]
        ...
        button.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                JOptionPane.showMessageDialog(null, "�û�" + id + " ��������Ϊ123456���ɹ�", null, JOptionPane.PLAIN_MESSAGE);
        ...
        button_1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                String id = (String) table.getValueAt(sc, 1);
                AdminBLL.comOff(id);
                JOptionPane.showMessageDialog(null, "�û�" + id + "ǿ�����ߣ��ɹ�", null, JOptionPane.PLAIN_MESSAGE);
                updateTable();
                table.updateUI();
            }
        });

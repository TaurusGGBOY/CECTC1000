...
public class Test3 extends JFrame {
	...
	public Test3() {
		...
		DefaultTreeCellRenderer dtcr = new DefaultTreeCellRenderer();// 定义树节点的绘制器
		ImageIcon leafIcon = new ImageIcon("src/ggb/s8/ui/管理员.png");
		if (leafIcon != null) {
		...
		tree.setCellRenderer(dtcr);// 设置树的节点绘制器
		dtcr.setOpenIcon(new ImageIcon("src/ggb/s8/ui/二维码图标1.png"));
		dtcr.setClosedIcon(new ImageIcon("src/ggb/s8/ui/创始人.png"));
		dtcr.setLeafIcon(new ImageIcon("src/ggb/s8/ui/管理员.png"));
